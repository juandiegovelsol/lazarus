...
function getTop10DonorsNearby(donors: Donor[], location: { lat: number; lng: number }): Donor[] {
...
async function main() {
    ...
    console.log(`Found ${matchedDonors.length} donors with blood type ${recipient.bloodType}`);
