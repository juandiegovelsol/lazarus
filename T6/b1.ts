...
// Example usage:
console.log(primeFactorization(315)); // Output: Prime factors: 3, 3, 5, 7
console.log(primeFactorization([315, 100, 23]));
// Output: [ 'Prime factors: 3, 3, 5, 7', 'Prime factors: 2, 2, 5, 5', 'Prime factors: 23' ]
