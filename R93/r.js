...
/**
 * Ask the user for a new username to be displayed in the app and then reconnect to the app with the new username
 */
function modifyName() {
...
/**
 * Designate a specific channel as the current channel
...
/**
 * Designate the general channel as the current channel
 */
 ...
 * @param {Channel} channel - The channel object.
 * @param {div} parent - The parent element.
 */
...
/**
 * Increment the counter for the number of unread new messages.
 */
function newMessage() {
  cptr++;
  updateNbNewMessage();
...
/**
 * Print a message when the connection to the websocket closes.
 */
 ...
 * @param {div} element - The element to reset.
 */
 ...
 * @param {div} box - The chatbox element.
 * @param {div} content - The message content element.
 * @param {div} date - The message date element.
