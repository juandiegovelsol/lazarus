...
const canvas = document.getElementById("gameCanvas") as HTMLCanvasElement; // The HTML canvas element where the game will be rendered
const ctx = canvas.getContext("2d"); // The 2D drawing context of the canvas

const canvasWidth = 400; // The width of the canvas in pixels
const canvasHeight = 400; // The height of the canvas in pixels
...
/**
 * Draws the game board by filling the canvas with a black background.
 */
function drawBoard() {
  ctx.fillStyle = "black";
...
/**
 * Displays the difficulty modes and allows the player to select one.
 */
...
/**
 * The main game loop that updates and renders the game state.
 */
function gameLoop() {
