...
const snake: { x: number; y: number }[] = [
  // The snake represented as an array of segments with x and y coordinates
  { x: 200, y: 200 },
  { x: 190, y: 200 },
  { x: 180, y: 200 },
  { x: 170, y: 200 },
...
function updateSnake() {
  const head = snake[0]; // The current head of the snake
...
function displayDifficulties() {
  const difficultyContainer = document.createElement("div"); // The container for difficulty buttons
  difficultyContainer.style.textAlign = "center";
  difficultyContainer.style.marginBottom = "20px";

  const easyButton = document.createElement("button"); // The button for Easy difficulty
  ...
  const mediumButton = document.createElement("button"); // The button for Medium difficulty
  ...
  const hardButton = document.createElement("button"); // The button for Hard difficulty
