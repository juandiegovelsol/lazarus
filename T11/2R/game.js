...
//New event listener to capture when a key is pressed
window.addEventListener("keydown", (event) => {
  keysPressed[event.key] = true;
  handleMovement();
});

//New event listener to capture when a key is released
window.addEventListener("keyup", (event) => {
  keysPressed[event.key] = false;
  handleMovement();
});

//New function to control if the movement with move or moveDiagonal
...
class Player {
  ...
  //New method to move the player in both X and Y directions
