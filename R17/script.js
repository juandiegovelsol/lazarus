...
// Wind parameters
const windSpeed = 3; // 3 m/s
const windAngle = (315 * Math.PI) / 180; // 315 degrees in radians (NW direction)
const windForceX = (windSpeed * Math.cos(windAngle)) / 60; // Divide by 60 to convert m/s to pixels per frame
const windForceY = (-windSpeed * Math.sin(windAngle)) / 60; // Negative because canvas Y is inverted
