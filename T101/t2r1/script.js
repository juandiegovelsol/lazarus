...
const minPrice = Math.min(...data); // Find the minimum price for scaling the chart
const maxPrice = Math.max(...data); // Find the maximum price for scaling the chart
const chartWidth = chart.offsetWidth;
const chartHeight = chart.offsetHeight;
let timeframeValue = parseInt(timeframeSelect.value);
...
timeframeSelect.addEventListener("change", () => {
  timeframeValue = parseInt(timeframeSelect.value);
  createCandles();
});
