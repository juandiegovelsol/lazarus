...
let isDifficultyLevelChanged = false; // Flag to track if the difficulty level has been changed
...
window.addEventListener("keydown", (event) => {
  ...
  // Prevent changing difficulty level with arrow keys
  if (
    isDifficultyLevelChanged &&
...
difficultyLevelSelect.addEventListener("change", (event) => {
  ...
  isDifficultyLevelChanged = true; // Set flag to prevent changing difficulty level with arrow keys
  clearInterval(gameIntervalId);
