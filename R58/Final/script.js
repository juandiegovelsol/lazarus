document.querySelector(".toggle-bg").addEventListener("click", function () {
  ...
  if (darkMode) {
    const newColor =
      currentColor === "rgb(51, 51, 51)"
        ? "rgb(27, 18, 18)"
        : "rgb(51, 51, 51)";
    header.style.backgroundColor = newColor;
    const toggleButton = document.querySelector(".toggle-bg");
    toggleButton.style.color =
      newColor === "rgb(51, 51, 51)" ? "rgb(27, 18, 18)" : "rgb(51, 51, 51)";
  } else {
    const newColor =
      currentColor === "rgb(0, 123, 255)"
        ? "rgb(255, 69, 0)"
        : "rgb(0, 123, 255)";
    header.style.backgroundColor = newColor;
    const toggleButton = document.querySelector(".toggle-bg");
    toggleButton.style.color =
      newColor === "rgb(0, 123, 255)" ? "#007BFF" : "#FF4500";
  }
});
