...
class EnglishWordChallenge:
    ...
    def challenge_2(self):
        ...
        start_time = time.time()
        print(f"{player1_name}, enter as many words as possible using the letters of '{word}':")
        while True:
            player1_word = input()
        ...
        start_time = time.time()
        print(f"{player2_name}, enter as many words as possible using the letters of '{word}':")
        while True:
            player2_word = input()
        ...
        print(f"\n{player1_name} entered {len(player1_words)} words in {player1_time:.2f} seconds.")
        print(f"{player2_name} entered {len(player2_words)} words in {player2_time:.2f} seconds.")
