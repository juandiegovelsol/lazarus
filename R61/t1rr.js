...
function game() {
    return __awaiter(this, void 0, void 0, function () {
        var score, totalComparisons, totalExchanges, totalIndexOperations, round, _loop_1, state_1;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 3:
                                    ...
                                    console.log("Average comparisons per round: ".concat(totalComparisons / round));
                                    console.log("Average exchanges per round: ".concat(totalExchanges / round));
                                    console.log("Average index operations per round: ".concat(totalIndexOperations / round));
