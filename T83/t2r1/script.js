...
let hasDifficultyLevelBeenChanged = false;
...
window.addEventListener("keydown", (event) => {
  // Prevent difficulty level from being changed using arrow keys
  if (!hasDifficultyLevelBeenChanged && event.key.startsWith("Arrow")) {
...
difficultyLevelSelect.addEventListener("change", (event) => {
  hasDifficultyLevelBeenChanged = true;
...
// Prevent difficulty level from being changed using arrow keys
difficultyLevelSelect.addEventListener("keydown", (event) => {
